...
// 6.4.1  ocid1.image.oc1..aaaaaaaab3v7bcoqsbrlgw6v3warlwb4hyuiowqk3fnxzrik7dqlgmkzr7zq
variable "mp_listing_resource_id" {
  default = "ocid1.image.oc1..aaaaaaaab3v7bcoqsbrlgw6v3warlwb4hyuiowqk3fnxzrik7dqlgmkzr7zq" //6.4.1 byol
}

// Version
variable "mp_listing_resource_version" {
  default = "6.4.1_SR-IOV_Paravirtualized_Mode"
}

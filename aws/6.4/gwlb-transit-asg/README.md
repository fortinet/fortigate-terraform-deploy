# Deployment of FortiGate-VM (PAYG) on the AWS with GWLB integration and Transit Gateway with Autoscale
## Introduction
...
Customer VPC (20.1.0.0/16)
       ...
       application-az1  (20.1.1.0/24)
       public-az2   (20.1.2.0/24)
       application-az2  (20.1.3.0/24)
Customer 2 VPC (30.1.0.0/16)
       public-az1   (30.1.0.0/24)
       application-az1  (30.1.1.0/24)
       public-az2   (30.1.2.0/24)
       application-az2  (30.1.3.0/24)
